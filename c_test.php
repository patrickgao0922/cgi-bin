<?php
    ...
    if (strcmp($codeID, '') !== 0)
    {
      if (!file_exists('/home4/igloosof/public_html/iGloo/database/'.$codeID.'/CMDS.ig'))
      {
         echo 'iGloo:XXX666';
      }
      else
      {
         $lines = file_get_contents('http://igloohomecontrol.com/iGloo/database/'.$codeID.'/CMDS.ig');
         
         if (file_exists('/home4/igloosof/public_html/iGloo/database/'.$codeID.'/PCMDS.ig'))
         {
             echo 'iGloo:XXX666';
         ...
         if (strcmp($deleteFileWhenDone, 'n') == 0)
         {
            ...
            file_put_contents ('/home4/igloosof/public_html/iGloo/database/'.$codeID.'/PCMDS.ig', $lines);
      ...
      if (strcmp($deleteFileWhenDone, 'y') == 0 && file_exists('/home4/igloosof/public_html/iGloo/database/'.$codeID.'/PCMDS.ig'))
      {
          if ($debug == 'y')
          {
          ...
          unlink('/home4/igloosof/public_html/iGloo/database/'.$codeID.'/PCMDS.ig');
      }
    }
